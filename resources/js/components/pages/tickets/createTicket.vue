  ...
  <PageLayout pageName="Intelligence">
    <div class="grid grid-cols-12 gap-3 mb-6 pt-4">
            ...
            <div class="grid grid-cols-2 gap-y-5 gap-x-3">
              <div class="col-span-2">
                <div class="relative w-full">
                  <label for="productservice"
                         class="text-base text-blue-grey text-xs font-inter-700">Product/Service</label>
              ...
              <div class="col-span-2">
                <div class="relative w-full">
                  ...
                  <textarea type="text" v-model="complaint" placeholder="Write complaint" name="complaint"
                            id="complaint" class="mt-2 w-full secondary-textarea"></textarea>
              ...
              <div class="col-span-2">
                <div class="relative w-full">
                  ...
                  <input type="text" v-model="link" name="link" id="link" placeholder="Link"
            ...
            <div class="grid grid-cols-2 gap-y-5 gap-x-3">
              <div class="col-span-2">
                <div class="relative w-full">
                  ...
                  <input type="text" v-model="vendor_name" placeholder="Vendor Name" name="vendor_name" id="vendor_name"
                         class="mt-2 w-full secondary-input"/>
                  <p class="text-red pt-2 text-xs" v-if="errors && errors.vendor_name">{{ errors.vendor_name[0]}}</p>
                </div>
              </div>
              <div class="col-span-2 sm:col-span-1">
                <div class="relative w-full">
                  <label for="email_address" class="text-base text-blue-grey text-xs font-inter-700">Email
                    Address</label>
                  <input type="email" v-model="email_address" placeholder="Email Address" name="email_address"
                         id="email_address" class="mt-2 w-full secondary-input">
                  <p class="text-red pt-2 text-xs" v-if="errors && errors.email_address">{{ errors.email_address[0]}}</p>
                </div>
              </div>
              <div class="col-span-2 sm:col-span-1">
                <div class="relative w-full">
                  <label for="mobile_number" class="text-base text-blue-grey text-xs font-inter-700">Mobile
                    Number</label>
                  <input type="text" v-model="mobile_number" name="mobile_number" id="mobile_number"
                         placeholder="Mobile Number" class="mt-2 w-full secondary-input">
                  <p class="text-red pt-2 text-xs" v-if="errors && errors.mobile_number">{{ errors.mobile_number[0]}}</p>
                </div>
              </div>
              <div class="col-span-2 sm:col-span-1">
                <div class="relative w-full">
                  <div class="mt-2 w-full secondary-input" style="padding: 4px 0 0 0">
                    <v-select :filter="fuseSearch" :options="cities" :get-option-label="(option) => option.name"
                              placeholder="Choose" v-model="city" :reduce="cities => cities.name">
                      <template #option="{ name }">
                        {{ name }}
                      </template>
                    </v-select>
                    <p class="text-red pt-2 text-xs" v-if="errors && errors.city">{{ errors.city[0]}}</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <ContentCard cardTitle="Reported By">
          <div class="block p-2">
            <div class="grid grid-cols-2 gap-y-5 gap-x-3">
              <div class="col-span-2 sm:col-span-1">
                <div class="relative w-full">
                  <label for="reported_first_name" class="text-base text-blue-grey text-xs font-inter-700">First
                    Name</label>
                  <input type="text" v-model="reported_first_name" placeholder="First Name" name="reported_first_name"
                         id="reported_first_name" class="mt-2 w-full secondary-input"/>
                  <p class="text-red pt-2 text-xs" v-if="errors && errors.reported_first_name">{{ errors.reported_first_name[0]}}</p>
                </div>
              </div>
              <div class="col-span-2 sm:col-span-1">
                <div class="relative w-full">
                  <label for="reported_last_name" class="text-base text-blue-grey text-xs font-inter-700">Last
                    Name</label>
                  <input type="text" v-model="reported_last_name" placeholder="Last Name" name="reported_last_name"
                         id="reported_last_name" class="mt-2 w-full secondary-input">
                  <p class="text-red pt-2 text-xs" v-if="errors && errors.reported_last_name">{{ errors.reported_last_name[0]}}</p>
                </div>
              </div>
              <div class="col-span-2 sm:col-span-1">
                <div class="relative w-full">
                  <label for="reported_email_address" class="text-base text-blue-grey text-xs font-inter-700">Email
                    Address</label>
                  <input type="email" v-model="reported_email_address" placeholder="Email Addres"
                         name="reported_email_address" id="reported_email_address" class="mt-2 w-full secondary-input">
                  <p class="text-red pt-2 text-xs" v-if="errors && errors.reported_email_address">{{ errors.reported_email_address[0]}}</p>
                </div>
              </div>
              <div class="col-span-2 sm:col-span-1">
                <div class="relative w-full">
                  <label for="reported_mobile_number" class="text-base text-blue-grey text-xs font-inter-700">Mobile
                    Number</label>
                  <input type="text" v-model="reported_mobile_number" name="reported_mobile_number"
                         placeholder="Mobile Number" id="reported_mobile_number" class="mt-2 w-full secondary-input">
            ...
            <div class="grid grid-cols-2 gap-y-5 gap-x-3">
              <div class="col-span-2">
                      ...
                      <td class="cursor-pointer flex items-center ml-10 flex-nowrap h-15">
                        <svg v-if="violation.amount" @click.prevent="openModal('modalEditAmount', violation.id);" class="mr-2"
                          ...
                          <path
                            ...
                            fill="#1267E5"/>
                          <path d="M8.37868 2.79289L0 11.1716V14H2.82842L11.2071 5.62132L8.37868 2.79289Z"
                                fill="#1267E5"/>
                        </svg>
                        <p v-if="violation.amount" class="font-inter-400 text-base text-black whitespace-nowrap">Php
                          {{ violation.amount }}</p>
                        <p v-if="!violation.amount"
                           @click.prevent="openModal('modalAddAmount'); modalTicketID = violation.id"
                           class="font-opensans-600 text-base whitespace-nowrap" style="color:#5E72E4;">Add Amount</p>
                      </td>
                    </tr>
                    <tr class="relative">
                      <td>
                ...
                <div class="flex items-center justify-start w-full">
                  <button @click="openModal('modalViolation');"
                          class="mt-1 md:mt-0 min-w-0 md:min-w-110 w-full md:w-fit bg-blue text-sm font-opensans-600 mr-2 py-2.5 px-5 shadow-main text-white rounded-full flex items-center justify-center">
                    Add
                  </button>
                  <button @click="updateViolation()"
                          class="border border-blue mt-1 md:mt-0 min-w-0 md:min-w-110 w-full md:w-fit bg-white text-sm font-opensans-600 py-2.5 px-5 text-blue rounded-full flex items-center justify-center">
                    Update
                  </button>
                </div>
              </div>
        ...
        <ContentCard cardTitle="Assigned Agencies">
          <div class="block p-2 py-4 ">
            <div class="grid grid-cols-5 gap-y-5 gap-x-5">
              <div v-for="agency in currentAgencies" class="col-span-2 sm:col-span-1">
                <div v-for="item in agency">
                  <img :src="item.logo"
                       class="w-full mx-auto max-w-30 max-h-30 object-center rounded-full object-contain border-light border"
              ...
              <p class="text-red pt-2 text-xs" v-if="errors && errors.agencies">{{ errors.agencies[0]}}</p>
              <div @click="openModal('modalAgencies')" class="cursor-pointer col-span-2 sm:col-span-1">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120" fill="none"
                     class="w-full mx-auto max-w-30 rounded-full">
                  <circle cx="60" cy="60" r="59.5" stroke="#1267E5"/>
                  <path d="M60 48V60M60 60V72M60 60H72M60 60L48 60" stroke="#1267E6" stroke-width="2"
        ...
        <ContentCard cardTitle="Remarks">
          <div class="block p-2">
            <div class="grid grid-cols-2 gap-y-5 gap-x-3">
              <div class="col-span-2">
                <div class="relative w-full">
                  <textarea type="text" v-model="remarks" placeholder="Write your remark" name="remarks" id="remarks"
                            class="w-full secondary-textarea"></textarea>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="col-span-12 col-start-1 md:col-span-10 col md:col-start-2 mt-10 flex items-center justify-end">
        <button @click="openModal('modalSubmit')"
                class="mt-1 md:mt-0 w-full md:w-40 bg-blue text-sm font-opensans-600 mx-0 py-2.5 px-5 shadow-main text-white rounded-lg">
          Submit
        </button>
      </div>
    </div>
      ...
      <template v-slot:body>
        <form onsubmit="return false" class="block">
          <div class="grid grid-cols-2 gap-y-6 gap-x-3 mt-2">
            <div class="col-span-2">
              <p class="text-black font-inter-400 text-sm">Once ticket is submitted, we’ll automatically send a
                notification to the assigned agencies</p>
            </div>
            <div class="col-span-2">
              <div class="relative w-full">
                <input type="text" v-model="filterSearchAgency" placeholder="Search" name="selectagencies"
                       id="selectagencies" class="my-2 w-full secondary-input" style="padding-left: 35px;"/>
      ...
      <template v-slot:footer>
        <div class="flex items-center justify-end w-full">
          <button @click="closeModal"
                  class="border border-blue mt-1 md:mt-0 min-w-110 w-full md:w-fit bg-white text-sm font-opensans-600 mr-2 py-2.5 px-5 text-blue rounded-lg flex items-center justify-center">
            Close
          </button>
          <button @click="addChecked()"
    ...
    <Modal modalTitle="Add Violation" v-show="modalActive && showModal == 'modalViolation'" @close="closeModal">
      <template v-slot:body>
        <form onsubmit="return false" class="block">
          <div class="grid grid-cols-2 gap-y-6 gap-x-3">
            <div class="col-span-2">
              <div class="relative w-full">
                <input type="text" v-model="filterSearchViolation" placeholder="Search" name="selectviolations"
                       id="selectviolations" class="my-2 w-full secondary-input" style="padding-left: 35px;"/>
                <img src="/img/icon/search.svg" class="search-img" style="top: 23px;">
              </div>
              <div class="py-2">
                <label class="cursor-pointer flex items-start" v-for="(violation, index) in allViolations">
                  <input type="checkbox" class="mt-1"
                         @change.prevent="violationChecked(violation.id, violation.index, $event)" :value="violation.id"
                         v-model="chosenViolations">
                  <p class="font-inter-400 text-black font-base mx-4 ellipsis-2" style="height: 46px;">
                    {{ violation.violation }}</p>
                </label>
              </div>
            </div>
          </div>
      ...
      <template v-slot:footer>
        <div class="flex items-center justify-end w-full">
          ...
          <button @click="addCheckedViolation()"
                  class="mt-1 md:mt-0 min-w-110 w-full md:w-fit bg-blue text-sm font-opensans-600 py-2.5 px-5 shadow-main text-white rounded-lg flex items-center justify-center">
            Update
          </button>
        </div>
      ...
      <template v-slot:body>
        <form onsubmit="return false" class="block">
          <div class="grid grid-cols-2 gap-y-6 gap-x-3">
            <div class="col-span-2">
              <div class="relative w-full">
                <input type="text" v-model="violationAmount" placeholder="Search" name="selectviolations"
                       id="selectviolations" class="my-2 w-full secondary-input" style="padding-left: 47px;"/>
      ...
      <template v-slot:body>
        <form onsubmit="return false" class="block">
          <div class="grid grid-cols-2 gap-y-6 gap-x-3">
            <div class="col-span-2">
              <div class="relative w-full">
                <input type="text" v-model="violationAmount" placeholder="Enter amount" name="selectviolations"
                       id="selectviolations" class="my-2 w-full secondary-input" style="padding-left: 47px;"/>
                <p class="php font-inter-700 text-blue-grey">Php</p>
              </div>
            </div>
    ...
    <Modal v-show="modalActive && showModal == 'modalSubmit'" @close="closeModal">
      <template v-slot:body>
        ...
        <p class="font-inter-400 text-lg text-dark2 mb-11">After submitting your ticket, all assigned agencies will be
          immediately notified.</p>
      </template>
      <template v-slot:footer>
        <div class="flex items-center justify-end w-full">
          <button @click="closeModal"
...
export default {
  ...
  components: {AlertTop, SearchInputDropdown, PageLayout, ContentCard, vSelect, Modal},
  async mounted() {
    this.getAgencies()
    this.getProducts()
    this.getViolations()
