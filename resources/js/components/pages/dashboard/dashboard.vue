    ...
    <PageLayout :pageName="title">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-3">
            <div class="col-span-2 md:col-span-1">
                <ButtonCard link="/intelligence/FOR_REVIEW" arrow="true" cardTitle="For Review" :value="alltickets.filter((a) => (a.status == 'FOR_REVIEW')).length">
            ...
            <div class="col-span-2 md:col-span-1">
                <ButtonCard link="/intelligence/ACKNOWLEDGED" arrow="true" cardTitle="Acknowledged" :value="alltickets.filter((a) => (a.status == 'ACKNOWLEDGED')).length"  icon="/img/icon/warning-blue.svg">
            ...
            <div class="col-span-2 md:col-span-1">
                <ButtonCard link="/intelligence/ON_GOING" arrow="true" cardTitle="On-going" :value="alltickets.filter((a) => (a.status == 'ON_GOING')).length"  icon="/img/icon/flag.svg">
            ...
            <div class="col-span-2 md:col-span-1">
                <ButtonCard link="/intelligence/RESOLVED" arrow="true" cardTitle="Resolved" :value="alltickets.filter((a) => (a.status == 'RESOLVED')).length"  icon="/img/icon/penalties.svg">
            ...
            <div class="col-span-2 md:col-span-1">
                <ButtonCard link="/intelligence/INVALID" arrow="true" cardTitle="Invalid" :value="alltickets.filter((a) => (a.status == 'INVALID')).length"  icon="/img/icon/invalid-blue.svg">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
